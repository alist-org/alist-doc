...
How to get reference to this [issue](https://github.com/Xhofe/alist/issues/88) Capture/find the log on the mobile phone (/data/media/0/Android/data/com.alicloud.databox/ files/logs/trace/), or:

import AliToken from '/src/components/AliToken'

<AliToken/>

*(use https://easy-token.cooluc.com/)*
